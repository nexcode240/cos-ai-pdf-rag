"""RAG pipeline implementation (single collection)."""
import logging
...
class RAGPipeline:
    ...
    This is the simpler single-collection path. For multi-PDF querying
    with source attribution, see src.api.services.rag_service.RAGService.
    """
